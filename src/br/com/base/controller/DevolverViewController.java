 ...
 * @author Edson
 */
public class DevolverViewController implements Initializable ,ControllerView {
    ...
    private void InicializaComboBox() {
        try {
            List<Motivos> lista = new MotivoDao().get(Constantes.TIPODEVOLUCAO);
    ...
    private boolean validaTela(){
      ...
      return false;
        ...
        public void DevolverOrdem() throws Exception {
